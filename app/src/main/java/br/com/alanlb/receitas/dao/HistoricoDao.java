...
public class HistoricoDao {
    ...
    public void salvarHistorico(Context context, Receita receita) throws SqliteException {
    ...
    public static Historico buscarPorID(/*int id*/) throws SqliteException {
//        pegaBD(context);
//        nome = "'%" + nome + "%'";
...
//        FactorySQL.closedb(context);
    ...
    public List<Receita> buscarTodosOsHistoricos(Context context) throws SqliteException {
